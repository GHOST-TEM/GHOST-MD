  ...
  viewOnceMessage: {
    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          ...(await prepareWAMessageMedia({ image : { url: 'https://telegra.ph/file/397000a07a1deb7fad9c2.jpg'}}, { upload: conn.waUploadToServer})), 
            title: null,
            subtitle: null,
            ...
            buttons: [
              {
                ...
                "buttonParamsJson": "{\"display_text\":\"Owner✨❤️\",\"id\":\".owner\"}"
                  ...
                  {
                  "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"BOT SC 🎉\",\"url\":\"https://github.com/GHOST-MD-V3/GHOST-V3-MD.git\",\"merchant_url\":\"https://github.com/GHOST-MD-V3/GHOST-V3-MD.git\"}"
              }
           ],
          })
        })
